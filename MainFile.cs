...
public class MainClass
{
    public static void Main()
    {
        ...
        Menu menuOfAdd = new Menu(
                                  new FuntionObject("Ввести значение вручную", () => { programmOfArray.InputArray(); }),
        ...
        Menu juniorMenu = new Menu(new FuntionObject("Показать отсотрированный массив", () => { programmOfArray.OutputSortedArray(); }),
                                   ...
                                   new FuntionObject("Добавить значения в массив", () => { menuOfAdd.StartMenu(); }),
